...
namespace FUMiniHotel.Migrations
{
    ...
    [Migration("20250225015006_FixBookingDetailRelationship")]
    partial class FixBookingDetailRelationship
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FUMiniHotel.Models.BookingDetail", b =>
                {
            ...
            modelBuilder.Entity("FUMiniHotel.Models.BookingReservation", b =>
                {
                    b.Property<int>("BookingReservationID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FUMiniHotel.Models.RoomInformation", b =>
                {
                    b.Property<int>("RoomID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FUMiniHotel.Models.RoomType", b =>
                {
                    b.Property<int>("RoomTypeID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FUMiniHotel.Models.BookingDetail", b =>
                {
                    b.HasOne("FUMiniHotel.Models.BookingReservation", "BookingReservation")
                        .WithMany("BookingDetails")
                        .HasForeignKey("BookingReservationID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FUMiniHotel.Models.RoomInformation", "Room")
                        .WithMany()
            ...
            modelBuilder.Entity("FUMiniHotel.Models.RoomInformation", b =>
                {
                    b.HasOne("FUMiniHotel.Models.RoomType", "RoomType")
                        .WithMany()
